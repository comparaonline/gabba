...
describe Gabba::Gabba do
  ...
  describe "when tracking custom events" do
    before do
      ...
      @gabba.utmn = "1009731272"
      @gabba.utmcc = ''
      stub_analytics @gabba.event_params("cat1", "act1", "lab1", "val1", '/page_event', false, "6783939397")
    end
    ...
    it "must do event request to google" do
      @gabba.event("cat1", "act1", "lab1", "val1", '/page_event', false, "6783939397").code.must_equal("200")
    end

    it "must be able to send non interactive events" do
      @gabba.event("cat1", "act1", "lab1", "val1", '/page_event', true).code.must_equal("200")
    end
